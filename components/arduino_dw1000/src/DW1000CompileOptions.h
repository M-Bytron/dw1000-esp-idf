 ...
 *
 * ESP-IDF port: disabled, so DW1000Time does not inherit from Arduino's
 * Printable class and the Serial/Print helpers are not compiled (there is no
 * Arduino Serial in ESP-IDF).
 */
